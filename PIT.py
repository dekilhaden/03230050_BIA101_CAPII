...
def calculate_premium(insurance_scheme, premium_amount):
    ...
    # List of insurance schemes with 50% deduction
...
# Example usage
employee = Employee(50000, 10)  # An employee with a salary of 50000 and a bonus rate of 10%
bonus = employee.calculate_bonus()
print(f"The bonus for this employee is: {bonus}")
